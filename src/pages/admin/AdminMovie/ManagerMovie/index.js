  ...
  useEffect(() => {
    const fetchListMovies = async () => {
      try {
        ...
        setTotalPagesCalculated(res.totalPages);
      } catch (error) {
        console.error("Error fetching movies:", error);
        notify("Error fetching movies. Please try again.");
      } finally {
        setLoadings(false);
      }
    };
    ...
    fetchListMovies();
  }, [selectedPage]); // Only re-fetch on page change
