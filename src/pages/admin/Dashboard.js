              ...
              <div className="dashbox">
                <div className="dashbox__title">
                  ...
                  <div className="dashbox__wrap">
                    ...
                    <a className="dashbox__more" href="users.html">
                      View All
                    </a>
                  </div>
                </div>
                  ...
                  <table className="main__table main__table--dash">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div className="main__table-text">BrianXWZ</div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                          <div className="main__table-text">Jesse.P</div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <div className="main__table-text">21</div>
                        </td>
                        <td>
                          <div className="main__table-text">
                            <a href="#">Matt Jones</a>
                        ...
                        <td>
                          <div className="main__table-text">Matty</div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <div className="main__table-text">20</div>
                        </td>
                        <td>
                          <div className="main__table-text">
                        ...
                        <td>
                          <div className="main__table-text">Harper123</div>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <div className="main__table-text">19</div>
                        </td>
                        <td>
                          <div className="main__table-text">
                        ...
                        <td>
                          <div className="main__table-text">Jonathan</div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="dashbox">
                <div className="dashbox__title">
                  ...
                  <div className="dashbox__wrap">
                    ...
                    <a className="dashbox__more" href="reviews.html">
                      View All
                    </a>
                  </div>
                </div>
                <div className="dashbox__table-wrap dashbox__table-wrap--4">
                  <table className="main__table main__table--dash">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div className="main__table-text">51</div>
                        </td>
                        <td>
                          <div className="main__table-text">
                            <a href="#">I Dream in Another Language</a>
                      ...
                      <tr>
                        <td>
                          <div className="main__table-text">50</div>
                        </td>
                        <td>
                          <div className="main__table-text">
                            <a href="#">Benched</a>
                        ...
                        <td>
                          <div className="main__table-text">Charles Baker</div>
                        </td>
                        <td>
                          <div className="main__table-text main__table-text--rate">
                            <svg
                      ...
                      <tr>
                        <td>
                          <div className="main__table-text">49</div>
                        </td>
                        <td>
                          <div className="main__table-text">
                            <a href="#">Whitney</a>
                      ...
                      <tr>
                        <td>
                          <div className="main__table-text">48</div>
                        </td>
                        <td>
                          <div className="main__table-text">
                            <a href="#">Blindspotting</a>
                      ...
                      <tr>
                        <td>
                          <div className="main__table-text">47</div>
                        </td>
                        <td>
                          <div className="main__table-text">
                            <a href="#">I Dream in Another Language</a>
